...
export const setupPrinter = () => {
  ...
  ipcMain.on("print-receipt", async (event, details) => {
    const { items, transactionNumber, tableNumber, dineInOrTakeout, newOrderNumber, cashierName } = details;
    ...
    const data = [
        {
            ...
            style: { fontWeight: 'bold', textAlign: 'center', fontSize: '42px', marginBottom: '10px' },
        },
        {
            type: 'image',
        ...
        {
            type: 'text',
            value: 'TAPLOKAL RECEIPT',
            style: { fontWeight: 'bold', textAlign: 'center', fontSize: '14px', marginTop: '10px' },
        },
        {
            type: 'text',
            value: `Trans. No: ${transactionNumber}`,
            style: { textAlign: 'left', fontSize: '10px', marginTop: '10px', marginBottom: '5px', marginLeft: '10px' },
        },
        {
            type: 'text',
            value: `Table No: ${tableNumber}`,
            style: { textAlign: 'left', fontSize: '10px', marginBottom: '5px', marginLeft: '10px' },
        },
        {
            type: 'text',
        ...
        },
        {
            ...
            tableBody: [
                ...
                [
                    ...
                    {
                        type: 'text',
                        value: `₱${(total - parseFloat((total * 0.12).toFixed(2))).toFixed(2)}`,
                        style: { fontWeight: 'bold', textAlign: 'left' },
                    },
                ],
                [
        ...
        },
        {
            ...
            style: { textAlign: 'center', fontSize: '10px', fontWeight: 'bold', marginTop: '10px' },
        },
        {
            type: 'text',
